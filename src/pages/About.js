      ...
      <div className="bg-[#e3dac9] overflow-x-hidden">
        ...
        <div className="grid md:grid-cols-[2fr_1fr] sm:grid-cols-1 gap-10 p-10 items-center">
          <img
            ...
            alt="About Hero 1"
            className="w-full max-w-full h-[400px] object-cover rounded-2xl shadow-md"
            data-aos="fade-right"
          />
          <img
            src="./img/about-hero-02.jpg"
            alt="About Hero 2"
            className="w-full max-w-full h-auto max-h-[400px] rounded-2xl shadow-md justify-self-center"
            data-aos="fade-left"
          />
        </div>
        ...
        <div className="font-serif p-10 md:p-16 bg-[#d1bea8] -mt-48">
          <div className="flex flex-col sm:divide-y-[1px] sm:divide-[#8a795d] md:flex-row md:divide-x-[1px] md:divide-y-0 md:divide-[#8a795d] text-center md:text-center sm:text-left mb-20 mt-52">
        ...
        <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-10 p-10 items-center font-serif mt-20">
          ...
          <div className="flex justify-center md:justify-start">
            <img
              ...
              alt="My Story"
              className="rounded-lg w-full max-w-full md:w-[400px] object-cover md:ml-0"
              data-aos="fade-up"
            />
          </div>

          <div className="text-sm leading-relaxed sm:text-center md:text-left">
            <p>
            ...
            <p className="mt-6">
              Today, I share insights and experiences through my blog, inspiring
              others to see the world — and their stories — in a whole new
              light.
            </p>
          </div>
        </div>
        ...
        <div className="mt-32 grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
          <div>
            <img
          ...
          <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-8 items-center">
            ...
            <div className="relative w-full flex justify-center md:justify-end">
              <img
                ...
                className="w-full max-w-full md:w-[90%] rounded-lg object-cover"
                data-aos="fade-up"
              />
              <img
                src="./img/flavours-01.jpg"
                alt="Flavors overlay"
                className="absolute w-2/3 sm:w-3/4 md:w-1/2 rounded-lg shadow-lg bottom-0 right-2 md:-bottom-10 md:-right-10"
                data-aos="fade-left"
              />
            </div>
          </div>
