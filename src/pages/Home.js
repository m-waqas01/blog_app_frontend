    ...
    <>
      ...
      <div className="bg-[#e3dac9]">
        <div className="text-center px-6 py-20 sm:px-12 md:px-24 lg:px-32 xl:px-40 font-sans">
          <p className="uppercase flex justify-center items-center gap-2 font-serif">
            <svg
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-4 p-10">
            ...
            <div className=" border border-[#856d4d] ">
              <img src="./img/post-free-01.jpg" alt="" data-aos="fade-up" />
            ...
            {/* Card 2 */}
            <div className=" border border-[#856d4d] ">
              <img src="./img/post-free-02.jpg" alt="" data-aos="fade-up" />
              <div className="text-center">
                <h1 className="font-semibold font-serif mt-8 ml-8 mr-8">
            ...
            {/* Card 3 */}
            <div className=" border border-[#856d4d] ">
              <img src="./img/post-free-03.jpg" alt="" data-aos="fade-up" />
              <div className="text-center">
                <h1 className="font-semibold font-serif mt-8 ml-8 mr-8">
        ...
        <div className="mt-72">
          <div>
            ...
            <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-4 p-10">
              {/* Card 4 */}
              <div className=" border border-[#856d4d] ">
                <img src="./img/post-free-12.jpg" alt="" data-aos="fade-up" />
                <div className="text-center">
                  <h1 className="font-semibold font-serif mt-8 ml-8 mr-8">
                    The Future of Wearable Tech: Innovations Shaping Our Lives
                  </h1>
              ...
              {/* Card 5 */}
              <div className=" border border-[#856d4d] ">
                <img src="./img/post-free-11.jpg" alt="" data-aos="fade-up" />
                <div className="text-center">
                  <h1 className="font-semibold font-serif mt-8 ml-8 mr-8">
                    Unplugged Adventures: How Digital Detoxing Transformed My
                    Travels
              ...
              {/* Card 6 */}
              <div className=" border border-[#856d4d] ">
                <img src="./img/post-free-09.jpg" alt="" data-aos="fade-up" />
                <div className="text-center">
                  <h1 className="font-semibold font-serif mt-8 ml-8 mr-8">
                    From Burnout to Balance: My Journey to Wellness and
                    Productivity
        ...
        <div className="mt-32">
          <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
            <div>
              <img src="./img/who-am-img.jpg" alt="" data-aos="fade-right" />
            </div>
